...
def test_first_launch_seeds_default_then_reads_it_back(tmp_path, monkeypatch):
...
def test_second_launch_reads_existing_without_overwriting(tmp_path, monkeypatch):
    config_file = tmp_path / "config.json"
