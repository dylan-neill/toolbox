...
def test_default_path_is_dot_config_on_every_platform(system):
...
def test_toolbox_config_file_overrides(tmp_path):
...
def test_toolbox_config_directory_gets_config_json_appended(tmp_path):
...
def test_toolbox_config_expands_user(tmp_path):
